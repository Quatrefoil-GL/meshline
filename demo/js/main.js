...
import { MeshLine, MeshLineMaterial } from "../../src/meshline";
...
for (var j = 0; j < TAU - 0.1; j += TAU / 100) {
  vertices.push(Math.cos(j), Math.sin(j), 0);
}
vertices.push(vertices[0], vertices[1], vertices[2]);

hexagonGeometry.setAttribute("position", new THREE.BufferAttribute(new Float32Array(vertices), 3));
...
var colors = [
  0xed6a5a, 0xf4f1bb, 0x9bc1bc, 0x5ca4a9, 0xe6ebe0, 0xf0b67f, 0xfe5f55, 0xd6d1b1, 0xc7efcf, 0xeef5db, 0x50514f, 0xf25f5c, 0xffe066, 0x247ba0, 0x70c1b3,
];
